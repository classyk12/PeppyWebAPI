...
using PeppyWeb.Providers;
using PeppyWeb.Results;
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = ApplicationOAuthProvider.CreateProperties(user.UserName,user.Email, user.DateJoined, user.ImagePath, user.PhoneNumber, user.Id);
